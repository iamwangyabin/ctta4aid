# Vendored from https://github.com/liangchen527/OST at commit
# 1e4518b9e560baf9c5693f13a402fa5d7104190f.
# The upstream OST repository declares no repository-wide software license.
# Local compatibility change: torch.where masks use bool instead of uint8.
...
class AMSoftmaxLoss(nn.Module):
    ...
    def forward(self, cos_theta, target):
        ...
        index = torch.zeros_like(cos_theta, dtype=torch.bool)
