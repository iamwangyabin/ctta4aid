...
class T2A(TTAMethod):
    ...
    def __init__(self, model: Any, device: Any, config: dict[str, Any] | None = None) -> None:
        ...
        from online_aig_tta.official import t2a as official_t2a
        from online_aig_tta.official.t2a_losses import Entropy
    ...
    def reproduction_metadata(self) -> dict[str, Any]:
        return {
            ...
            "official_core": "online_aig_tta.official.t2a",
